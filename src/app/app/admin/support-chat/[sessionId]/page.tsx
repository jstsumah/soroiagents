...
import { ArrowLeft, Bot, Loader2, Send, LogOut } from 'lucide-react';
...
export default function AdminChatPage() {
    ...
    React.useEffect(() => {
        if (!isAuthLoading && adminUser && adminUser.role === 'Agent') {
    ...
    const handleCloseChat = async () => {
        ...
        try {
            ...
            router.push('/app/admin/support-chat');
        } catch(e) {
            toast({
                variant: 'destructive',
                title: "Error",
    ...
    return (
        <div className="flex flex-col gap-4 h-full">
            <div className="flex items-center justify-between">
                ...
                {session.status === 'open' && (
                    <Button variant="destructive" onClick={handleCloseChat}>
             ...
             <Card className="flex flex-col flex-grow">
                ...
                <CardFooter className="p-4 border-t">
                    <div className="flex w-full items-center gap-2">
                        ...
                        />
                        <Button onClick={handleSendMessage} disabled={isSending || session.status === 'closed'}>
