...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 my-1 flex min-w-0 translate-x-px flex-col gap-2 border-l border-sidebar-border px-2.5 py-2",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-auto min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-3 py-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
